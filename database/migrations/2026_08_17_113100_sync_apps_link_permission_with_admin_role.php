...
/**
 * Adds the apps_link permission subject (App Store / Google Play link
 * management, under site_info -> Global Data) and grants it in full to the
 * 'admin' role. Same safe, additive, idempotent pattern as
