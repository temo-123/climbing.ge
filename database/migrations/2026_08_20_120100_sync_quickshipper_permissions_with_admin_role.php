...
/**
 * Adds the 'quick_shipper' permissions (delivery integration, test/scaffold
 * branch) and grants them to the 'admin' role. Same safe, additive,
 * idempotent pattern as 2026_08_09_120700_sync_training_permissions_with_admin_role.php.
 */
