        ...
        */
        ...
        Route::prefix('task')->group( function() {
            ...
            Route::controller(TaskCategoryController::class)->prefix('task_category')->group( function() {
                ...
                Route::get('/get_editing_task_category/{category_id}', 'get_editing_task_category');

                Route::post('/create_task_category', 'create_task_category');
                Route::post('/update_task_category/{task_id}', 'update_task_category');

                Route::delete('/del_task_category/{task_id}', 'del_task_category');
            });
        });
    });
