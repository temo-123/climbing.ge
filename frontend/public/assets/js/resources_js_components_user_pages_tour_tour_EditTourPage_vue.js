"use strict";
(self["webpackChunkclimbing_loc"] = self["webpackChunkclimbing_loc"] || []).push([["resources_js_components_user_pages_tour_tour_EditTourPage_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/user/pages/tour/tour/EditTourPage.vue?vue&type=script&lang=js&":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/user/pages/tour/tour/EditTourPage.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    get_editing_tour_data: function get_editing_tour_data() {
      var _this2 = this;
      this.data_for_tab = [];
      this.is_loading = true;
      axios.get("tour/get_editing_tour/" + this.$route.params.id).then(function (response) {
        ...
        _this2.tour_old_images = response.data.tour_images;
        _this2.get_tour_images();
      })["catch"](function (error) {
        return console.log(error);
      })["finally"](this.is_loading = false);
    },
    get_tour_images: function get_tour_images() {
      var _this3 = this;
      this.data_for_tab = [];
      axios.get("tour/get_tour_images/" + this.$route.params.id).then(function (response) {
        _this3.tour_old_images = response.data;
      })["catch"](function (error) {
        return console.log(error);
      });
    },
    del_tour_image_from_db: function del_tour_image_from_db(image_id) {
      var _this4 = this;
      if (confirm('Are you sure, you want delite this image?')) {
        axios["delete"]("tour/del_tour_image/" + image_id).then(function (response) {
          _this4.get_tour_images();
        })["catch"](function (error) {
          return console.log(error);
        });
      }
    ...
    change_url_title_in_global_tour: function change_url_title_in_global_tour() {
    ...
    edit_tour: function edit_tour() {
      ...
      var loop_num = 0;
      this.tour_new_images.forEach(function (image) {
        formData.append('tour_new_images[' + loop_num + ']', image.image);
        loop_num++;
      });
      loop_num = 0;
      formData.append('data', JSON.stringify(this.data));
      axios.post('tour/edit_tour/' + this.$route.params.id, formData).then(function (response) {
        _this5.go_back(true);
      })["catch"](function (error) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/user/pages/tour/tour/EditTourPage.vue?vue&type=template&id=1e445965&":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/user/pages/tour/tour/EditTourPage.vue?vue&type=template&id=1e445965& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_vm._m(2), _vm._v(" "), _c("tbody", _vm._l(_vm.tour_old_images, function (tour_old_image) {
    return _c("tr", {
      key: tour_old_image.id
    }, [_c("td", [_c("img", {
      staticClass: "img-responsive",
      attrs: {
        src: "../../../../images/tour_img/" + tour_old_image.image,
        alt: tour_old_image.title
      }
    })]), _vm._v(" "), _c("td", [_vm._v("|")]), _vm._v(" "), _c("td", [_c("button", {
      staticClass: "btn btn-danger",
      on: {
        click: function click($event) {
          return _vm.del_tour_image_from_db(tour_old_image.id);
        }
      }
    }, [_vm._v("Delete")])])]);
  ...
  }, [_vm._v("Add new tour imagee")])])])]), _vm._v(" "), _c("div", {
    staticClass: "row"
  }, [_c("div", {
    staticClass: "col-md-12"
  }, [_c("table", {
  ...
  }, [_vm._m(4), _vm._v(" "), _c("tbody", _vm._l(_vm.tour_new_images, function (tour_image) {
    return _c("tr", {
      key: tour_image.id
    }, [_c("td", [_c("form", {
      ref: "myForm",
    ...
    on: {
      click: function click($event) {
        return _vm.change_url_title_in_global_tour();
      }
    }
  })])]), _vm._v(" "), _c("div", {
    staticClass: "form-group clearfix"
...
/***/ "./resources/js/components/user/pages/tour/tour/EditTourPage.vue":
/*!***********************************************************************!*\
  !*** ./resources/js/components/user/pages/tour/tour/EditTourPage.vue ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _EditTourPage_vue_vue_type_template_id_1e445965___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./EditTourPage.vue?vue&type=template&id=1e445965& */ "./resources/js/components/user/pages/tour/tour/EditTourPage.vue?vue&type=template&id=1e445965&");
/* harmony import */ var _EditTourPage_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./EditTourPage.vue?vue&type=script&lang=js& */ "./resources/js/components/user/pages/tour/tour/EditTourPage.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _EditTourPage_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _EditTourPage_vue_vue_type_template_id_1e445965___WEBPACK_IMPORTED_MODULE_0__.render,
  _EditTourPage_vue_vue_type_template_id_1e445965___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/user/pages/tour/tour/EditTourPage.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/components/user/pages/tour/tour/EditTourPage.vue?vue&type=script&lang=js&":
/*!************************************************************************************************!*\
  !*** ./resources/js/components/user/pages/tour/tour/EditTourPage.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EditTourPage_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./EditTourPage.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/user/pages/tour/tour/EditTourPage.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EditTourPage_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/components/user/pages/tour/tour/EditTourPage.vue?vue&type=template&id=1e445965&":
/*!******************************************************************************************************!*\
  !*** ./resources/js/components/user/pages/tour/tour/EditTourPage.vue?vue&type=template&id=1e445965& ***!
  \******************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_EditTourPage_vue_vue_type_template_id_1e445965___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_EditTourPage_vue_vue_type_template_id_1e445965___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_EditTourPage_vue_vue_type_template_id_1e445965___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./EditTourPage.vue?vue&type=template&id=1e445965& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/user/pages/tour/tour/EditTourPage.vue?vue&type=template&id=1e445965&");
