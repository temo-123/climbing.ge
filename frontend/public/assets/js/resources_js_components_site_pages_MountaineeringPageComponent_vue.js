...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    get_mount_masiv: function get_mount_masiv() {
      var _this2 = this;
      axios.get('../api/mount/on_page/' + localStorage.getItem('lang') + '/' + this.mount_route.global_data.id).then(function (response) {
...
var render = function render() {
  ...
  })]) : _vm._e(), _vm._v(" "), this.mounts_system.locale_data.map != _vm.NULL ? _c("div", [_c("div", {
    staticClass: "article_map"
  }, [_c("span", {
    domProps: {
      innerHTML: _vm._s(this.mounts_system.locale_data.map)
    }
