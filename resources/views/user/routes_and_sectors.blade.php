            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <tabs_component 
                        ...
                        @if(isset($table_1_add_url)) table_1_add_url="{{ route($table_1_add_url) }}" @endif
                        @if(isset($table_2_add_url)) table_2_add_url="{{ route($table_2_add_url) }}" @endif
                        @if(isset($table_3_add_url)) table_3_add_url="{{ route($table_3_add_url) }}" @endif
                        @if(isset($table_4_add_url)) table_4_add_url="{{ route($table_4_add_url) }}" @endif
                    >
                    </tabs_component>
