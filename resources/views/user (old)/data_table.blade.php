            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    @elseif ($table_1_name == 'Products')
                        <h4><a target="_blank" href="#">Products list on general site</a></h4>
                    @elseif ($table_1_name == 'Services')
                        <h4><a target="_blank" href="#">Services list on general site</a></h4>
                    @elseif ($table_1_name == 'Orders' || $table_1_name == 'My Orders')
                    @else
                        @if($table_1_name != 'Sector' && $table_1_name != 'Gallery' && $table_1_name != 'Users' && $table_1_name != 'News')
