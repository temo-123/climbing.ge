...
@section('meta_img', (asset('/images/meta_img/mount.jpg')))
    ...
    <section class="portfolio" id="portfolio">
        <div class="container">
            <div class="row">
                ...
                <div class="filter_button_block" >
                    ...
                    <button class="filter-button" data-filter="{!! $tag->id !!}">{!! $tag->name !!}</button>
        ...
        <div class="continer">
            <div class="row">
                ...
                @if(isset($tags))
                <div class="food col-md-4 gallery_product filter {{ $article[0][0] -> mount_id }}">
                    @endif

                    <!--<div class="food col-md-4" style='horizontal-align: bottom;'>-->
                        <div style='horizontal-align: bottom;'>
