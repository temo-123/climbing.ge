<template>
  ...
  >
    ...
    <div v-else class="product-details">
      ...
      <div v-if="q_product.global_product" class="text-center mt-6 pt-4 border-t border-gray-200">
        <router-link :to="'product/'+q_product.global_product.url_title" class="btn btn-primary view-full-btn inline-block">
  ...
  methods: {
    ...
    retry_load() {
      if (this.current_product_id) {
        this.show_modal(this.current_product_id);
      }
    },
    close_modal() {
      this.is_show_modal = false;
...
<style scoped>
/* Existing styles unchanged - they work with StackModal */
