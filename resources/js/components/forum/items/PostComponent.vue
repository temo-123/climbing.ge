        ...
        <div v-if="posts.length">
            ...
            >
                <div class="cardbox-heading">
                    <div class="media m-0">
                        ...
                        <div class="media-body">
                            ...
                            <div class="row m-0">
                                <small
                                    ><span v-if="post['post'].created_at">{{
                ...
                <div class="cardbox-item" v-if="post['post'].image">
                    <forum-img
                        :img_class="'img-fluid'"
                        :src="'images/forum_post_img/' + post['post'].image"
                        :alt="'Image'"
                    />
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="post_comment_porm">
                            <textarea
                                ...
                                v-model="my_comment"
                            ></textarea>
                            <button @click="add_comment(post['post'].id)">Add</button>
                        </div>
                    </div>
...
export default {
    ...
    mounted() {
        this.get_posts();
        // console.log(this.get_post_likes(2))
    },
    methods: {
        get_posts() {
            axios
        ...
        get_post_comments(id) {
            // this.comments = [];
            axios
                .get("../api/post_comment/get_post_comment/" + id)
                .then((response) => {
        ...
        add_comment(post_id) {
            ...
            .then((response)=>{
                this.my_comment = ''
                // this.get_post_comments(post_id)
            })
            .cache((error) => {
