    ...
    <!-- <div class=""> -->
        <div :class="'mb-5 col-xs-6 col-sm-6 col-md-4'" >
            <div class="card h-100">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 film_cover_img">
                            <router-link :to="'../film/'+film.global_film.url_title">
                                <site-img
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <router-link :to="'../film/'+film.global_film.url_title">
                                <h2 class="card-title">{{ film.local_film.name }}</h2>
                            </router-link>

                            <p class="card-text">{{  film.local_film.short_description }}</p>
                        </div>
                    </div>
                </div>
                <!-- <div class="card-footer">
                    <router-link class="btn btn-primary btn-sm" :to="'film/'+film.url_title">
                        Open
                    </router-link>
                </div> -->
            </div>
