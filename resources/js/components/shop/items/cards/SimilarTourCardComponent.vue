<template>
    ...
    <div class="tours">
        <div class="tourcard">
            <figure>
                <div class="tourpic">
                    <shop-img width="320" height="180" v-if="tour_data.image" :src="'/public/images/tours_img/'+tour_data.image" :alt="tour_data.url_title" />
                    <shop-img width="320" height="180" v-else :src="'/public/images/site_img/shop_demo.jpg'" :alt="tour_data.url_title" />

                    <span class="tourcat">{{ tour_data.location }}</span>                             
                    <span class="tourday hot">{{ tour_data.min_price }} / par</span>
                </div>
                <figcaption>
                    <h3 class="entry-title">
                      <router-link :to="'../tour/'+tour_data.url_title">Katskhi Climbing Tour </router-link>
                    </h3>
                ...
                <div class="tourbtn">
                    <router-link class="btn btn-default123" :to="'../tour/'+tour_data.url_title">
