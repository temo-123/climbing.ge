            ...
            <div class="tab" >
                ...
                <form name="contact-form" method="POST" id="global_form" ref="myForm" @submit.prevent="add_article"  style="margin-top: 5%;" enctyp ="multipart/form-data">
                    ...
                    <div class="form-group clearfix row" v-if="this.category == 'event'">
                        ...
                        <div class="col-md-4">
                            <input type="text" v-model="end_data_day" name="end_data_day" class="form-control"  placeholder="end day data"> 
                        </div>
                        <div class="col-md-4">
                            <!-- <input type="text" v-model="end_data_month" name="end_data_month" class="form-control"  placeholder="end month">  -->
