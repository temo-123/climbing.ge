            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-hover" id="dev-table">
                        ...
                        <tbody>
                            <tr v-for="old_article_relatione in old_article_relationes" :key="old_article_relatione.id">
                                <td>
                                    {{ old_article_relatione.url_title }}
                                </td>
                                <td>|</td>
                                <td>
                                    <button class="btn btn-danger" @click="del_relatione_article_from_db(old_article_relatione.pivot.bisnes_id, old_article_relatione.pivot.article_id)">Delete</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.get_old_article_relations()
        ...
        methods: {
            ...
            get_old_article_relations(){
                // this.is_loading = true
                axios
                .get(this.get_articles_route_prop+this.$route.params.id)
                .then(response => {
                    this.old_article_relationes = response.data
                })
                .catch(
            ...
            del_relatione_article_from_db(bisnes_id, article_id){
                if(confirm('Are you sure, you want delite this article?')){
                    axios
                    .delete(this.article_del_route_prop + article_id + '/' + bisnes_id)
                    .then(response => {
                        this.get_old_article_relations()
                    })
                    .catch(
