<template>
    <div class="row">
        ...
        <comment_hide_modal ref="hide_comment_modal" @restart="get_my_guide_comments_data" />

        <reviewEditModal ref="review_edit_modal" @restart="get_my_guide_comments_data"/>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        get_my_products_feedbacks_data: function () {
            axios
                .get("/set_product_feedback/get_user_feedbacks")
                .then((response) => {
                    this.data_for_tab.push({
                        id: 3,
