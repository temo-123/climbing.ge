<template>
    <div class="tabs"> 
        ...
        <div class="row">
            <div class="form-group">  
                <button type="submit" class="btn btn-primary" v-on:click="edit_spot_region()" >{{ $t('common.save') }}</button>
            </div>
        </div>
        <div class="row" v-if="errors.length != 0">
            <div class="col-md-12">
                <div class="alert alert-danger" role="alert" v-if="errors.us_name">
                    {{ $t('admin.regions.error_prefix_en_name') }} {{ errors.us_name[0] }}
                </div>

                <div class="alert alert-danger" role="alert" v-if="errors.ka_name">
                    {{ $t('admin.regions.error_prefix_ka_name') }} {{ errors.ka_name[0] }}
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="row" v-show="tab_num == 1">
                <div class="jumbotron width_100">
                    <div class="container">
                        <h2 class="display-4"><span style="text-transform: capitalize">{{ $t('admin.regions.global_info_title') }}</span></h2>
                        <p class="lead">{{ $t('admin.regions.global_info_subtitle') }}</p>
                    </div>
                </div>
                <form >
            ...
            <div class="row" v-show="tab_num == 2">
                <div class="jumbotron width_100">
                    <div class="container">
                        <h2 class="display-4"><span style="text-transform: capitalize">{{ $t('admin.regions.en_info_title') }}</span></h2>
                        <p class="lead">{{ $t('admin.regions.en_info_subtitle') }}</p>
                    </div>
                </div>
                <form >
                    <div class="form-group clearfix">
                        <label for="name" class='col-xs-2 control-label'> {{ $t('admin.regions.en_name_label') }} </label>
                        <div class="col-xs-8">
                    ...
                    <div class="form-group clearfix row">
                        <label for="region" class='col-md-2 control-label '> {{ $t('admin.regions.en_text_label') }} </label>
            ...
            <div class="row" v-show="tab_num == 3">
                <div class="jumbotron width_100">
                    <div class="container">
                        <h2 class="display-4"><span style="text-transform: capitalize">{{ $t('admin.regions.ka_info_title') }}</span></h2>
                        <p class="lead">{{ $t('admin.regions.ka_info_subtitle') }}</p>
                    </div>
                </div>
                <form >
                    <div class="form-group clearfix">
                        <label for="name" class='col-xs-2 control-label'> {{ $t('admin.regions.ka_name_label') }} </label>
                        <div class="col-xs-8">
                    ...
                    <div class="form-group clearfix row">
                        <label for="region" class='col-md-2 control-label '> {{ $t('admin.regions.ka_text_label') }} </label>
    ...
    export default {
        ...
        methods: {
            get_editing_region_data(){
                ...
                // .catch(err => {
                //     alert("get_editing_region_data error => "+err)
                // })
            },
