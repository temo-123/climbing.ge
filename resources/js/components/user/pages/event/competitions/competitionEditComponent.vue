            ...
            <div class="col-md-12">
                <div class="row width_100" v-show="tab_num == 1">
                    <div class="jumbotron width_100">
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="display-4"><span>{{ $t('admin.events.competition_global_info_title') }}</span></h2>
                                <p class="lead">{{ $t('admin.events.competition_global_info_subtitle') }}</p>
                            </div>
                        </div>
                    </div>
                    <form class="width_100" name="contact-form" method="POST" id="global_form" ref="myForm" style="margin-top: 5%;" enctyp ="multipart/form-data">
                        ...
                        <div class="form-group clearfix">
                            <single_image_edit
                                :title_prop="$t('admin.events.competition_image_title')"
                ...
                <div class="row" v-show="tab_num == 2">
                    <div class="width_100 jumbotron jumbotron-fluid">
                        <div class="container">
                            <h2 class="display-4">{{ $t('admin.events.competition_en_version_title') }}</h2>
                            <p class="lead">{{ $t('admin.events.competition_en_version_subtitle') }}</p>
                        </div>
                    </div>
                ...
                <div class="row" v-show="tab_num == 3">
                    <div class="width_100 jumbotron jumbotron-fluid">
                        <div class="container">
                            <h2 class="display-4">{{ $t('admin.events.competition_ka_version_title') }}</h2>
                            <p class="lead">{{ $t('admin.events.competition_ka_version_subtitle') }}</p>
                        </div>
                    </div>
        ...
        methods: {
            ...
            change_event_category(){
                if(!this.is_change_event_category){
                    if(confirm(this.$t('admin.events.confirm_change_competition_category'))){
