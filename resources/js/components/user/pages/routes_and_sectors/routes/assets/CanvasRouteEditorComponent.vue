    ...
    methods: {
        ...
        async saveRouteDrawing() {
            ...
            try {
                ...
                const siblingMetas = await this._fetchAllSiblingMetas(this.images_tab_num, { excludeRouteId: this.route_id_prop });
        ...
        // route quickly after selecting its image (the natural, common
