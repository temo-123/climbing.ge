...
<div>
    <stack-modal
        :show="is_edit_modal"
        size="xxl"
        :title="$t('admin.shop.edit_combination_title')"
        @close="close"
        @save="save"
        ...
        <div v-show="!is_loading && !is_loading_modal" class="row g-3">
            ...
            <div class="col-md-4">
                <div v-if="editing_images.length > 0" class="mb-3">
                    <label class="form-label">{{ $t('admin.shop.saved_images_count', { count: editing_images.length }) }}</label>
                    <div class="row g-2">
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-footer p-1">
                                    <button class="btn btn-danger btn-sm w-100"
                                            @click="$emit('del_combination_image', img.id)">{{ $t('common.delete') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <gallery_images_add
                    :title_prop="$t('admin.shop.add_new_images_title')"
