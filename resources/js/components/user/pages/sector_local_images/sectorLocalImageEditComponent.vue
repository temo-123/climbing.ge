    ...
    export default {
        ...
        methods: {
            get_editing_image(){
                ...
                axios
                .get('/set_sector_local_images/get_editing_locale_image/'+this.$route.params.id)
                .then(response => {
            ...
            get_editing_sectors(){
                axios
                .get('/set_sector_local_images/get_editing_sectors/'+this.$route.params.id)
                .then(response => {
            ...
            del_image_sector_from_db(sector_id){
                if(confirm('Are you sure, you want delite itt?')){
                    axios
                    .post('/set_sector_local_images/del_image_sector_from_db/' + this.$route.params.id + '/' + sector_id,{
                        _method: 'delete',
                    })
                    .then(response => {
                        // alert(response.data)
            ...
            update(){
                ...
                axios.post('/set_sector_local_images/update_image/'+this.$route.params.id, 
