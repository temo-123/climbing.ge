        ...
        methods: {
            show_sector_local_image_modal(){
                if (!this.is_show_sector_local_image_modal) {
                    axios
                    .get('/get_sector_local_img/get_sector_local_img_for_modal/' + this.$route.params.id)
                    .then(response => {
            ...
            loadLayouts() {
                axios.get('/get_sector_local_img/get_layouts/' + this.$route.params.id)
                    .then(response => {
            ...
            selectLayout(layoutId) {
                axios.get('/get_sector_local_img/get_layout/' + layoutId)
                    .then(response => {
            ...
            createLayout() {
                if (this.selectedSectors.length > 0) {
                    axios.post('/set_sector_local_img/create_layout/' + this.$route.params.id, {
            ...
            saveChanges() {
                if (this.canvasData && this.selectedSectors.length > 0) {
                    axios.post('/set_sector_local_img/save_canvas_data/' + this.$route.params.id, {
