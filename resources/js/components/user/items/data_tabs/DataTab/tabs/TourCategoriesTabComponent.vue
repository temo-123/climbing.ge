<template>
    <tr>
        ...
        <editTourCategoryModal 
            ref="show_tour_category_edit_modal"
...
<script>
    import editTourCategoryModal from "../tab_modals/edit/EditTourCategoryModal"
    export default {
        components:{
            editTourCategoryModal,
        },
        ...
        methods: {
            show_edit_model(category_id){
                this.$refs.show_tour_category_edit_modal.open_modal(category_id)
            },
            editing_update(){
                this.$emit('restart')
            },
