<template>
    <tr>
        ...
        <td>|</td>
        <td>
            <router-link class="btn btn-primary" :to="{ name: 'productEdit', params: { id: table_info.global_product.id } }">Edit</router-link>
        </td>
        
        <td>|</td>
        <td>
            <button type="button" class="btn btn-danger" @click="del_products(table_info.global_product.id)">Delete</button>
        </td>
    </tr>
</template>
