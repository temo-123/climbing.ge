<template>
    <stack-modal
            ...
            :title="'Edit toure category'"
            @close="close_modal()"
            :saveButton="{ visible: true, title: 'Save', btnClass: { 'btn btn-primary': true } }"
            :cancelButton="{ visible: false, title: 'Close', btnClass: { 'btn btn-danger': true } }"
        >
        <pre class="language-vue">
            <h1>Edit toure category</h1>
    ...
    export default {
        ...
        methods: {
            get_editing_data(){
                ...
                axios
                .get("/toure/category/get_editing_category/"+this.editing_category_id)
                .then(response => {
            ...
            edit_toure_category: function(){
                this.is_loading = true,

                axios
                .post("/toure/category/edit_category/"+this.editing_category_id, {
                    data: this.form_data,
