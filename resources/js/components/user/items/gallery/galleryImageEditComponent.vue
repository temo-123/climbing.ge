<template>
    <div class="gallery-manager">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <h5 class="mb-0">{{ title_prop || 'Gallery Images' }}</h5>
        </div>

        <!-- Existing images from DB -->
        <div v-if="old_images.length > 0" class="mb-4">
            <p class="text-muted small mb-2">Saved images ({{ old_images.length }})</p>
            <div class="row g-2">
        ...
        <div v-else class="text-muted small text-center py-3">
            No new images added yet. Drop files above or click "Add Images".
        </div>
    </div>
</template>
