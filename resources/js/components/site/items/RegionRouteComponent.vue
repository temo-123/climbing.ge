                    ...
                    <table class="table col-md-12 table table-hover" >
                        ...
                        <tbody>
                            <tr v-for="route in sector['routes']" :key="route.id"> 
                                ...
                                <!-- <td>
                                    <a @click="show_route_info_madel(route.id)" style="margin-top: -5%; font-size: 120%;"><i class="fa fa-info-circle"></i></a>
                                </td> -->
                            </tr>
                        </tbody>
                    </table>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            show_route_info_madel(route_id){
                this.route_modal=true;
