<template>
    <div>
        ...
        <h3 class="navbar_title" v-if="local_businesses.length != 0">{{ $t('guide.article_right_nabar.recomended_services') }}</h3>

        <div class="row local_bisnes" v-if="local_businesses.length != 0">
    ...
    export default {
        ...
        methods: {
            get_local_bisnes_for_article(){
                ...
                axios
                .get('/api/get_bisnes/get_local_bisnes_for_article/' + this.$route.params.url_title + '/' + currentLang)
                .then(response => {
