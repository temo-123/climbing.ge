...
var render = function render() {
  ...
  return _c("div", {
    ...
    attrs: {
      config: this.editor_config.short_description_text
    },
    model: {
  ...
  })], 1)]), _vm._v(" "), this.category == "outdoor" ? _c("hr") : _vm._e(), _vm._v(" "), this.category != "mount_route" ? _c("div", {
    staticClass: "form-group clearfix row"
  }, [_c("label", {
    staticClass: "col-md-2 control-label",
    attrs: {
    ...
    attrs: {
      config: this.editor_config.how_get
    },
    model: {
  ...
  })], 1)]) : _vm._e(), _vm._v(" "), this.category == "outdoor" || this.category == "ice" ? _c("hr") : _vm._e(), _vm._v(" "), _c("GlobalInfoFormBlock", {
    attrs: {
  ...
  }), _vm._v(" "), _c("hr"), _vm._v(" "), this.category == "indoor" ? _c("div", {
    staticClass: "form-group clearfix row"
  }, [_c("label", {
    staticClass: "col-md-2 control-label",
    attrs: {
    ...
    attrs: {
      config: this.editor_config.price_text
    },
    model: {
