...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _items_MetaDataComponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../items/MetaDataComponent */ "./resources/js/components/films/items/MetaDataComponent.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    get_serching_data: function get_serching_data() {
      ...
      axios.get('../api/films_search/' + this.$route.query.query).then(function (response) {
